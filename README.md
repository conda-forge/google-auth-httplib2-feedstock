...
Home: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-auth-httplib2

Package license: Apache-2.0

Summary: Google Authentication Library httplib2 transport

Development: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-auth-httplib2
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-auth-httplib2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-auth-httplib2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-auth-httplib2
# for installing globally
pixi global install google-auth-httplib2
```
...
It is possible to list all of the versions of `google-auth-httplib2` available on your platform:
...
```
pixi search google-auth-httplib2 --channel conda-forge
```
